...
| `afk source add gherkin features/` | Add Gherkin/BDD .feature files |
...
**OpenSpec source:** Reads tasks from [OpenSpec](https://github.com/Fission-AI/OpenSpec) change proposals in `openspec/changes/<change-id>/tasks.md`. Enriches task context with spec deltas, proposals, and design docs.
...
1. **Load tasks** from configured sources (json, markdown, beads, github, openspec, gherkin)
